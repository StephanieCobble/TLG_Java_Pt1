...
public interface TaxPayer {
    ...
    public void payTaxes(); // is abstract, but don't specify, but most devs will still say public

    default public void fileReturn() {
        System.out.println("Return filed by US Mail"); // by default, can be overwritten in others classes
    }

    default public double getStandardDeduction() {
        return DEFAULT_STANDARD_DEDUCTION; // prints from IRS
    }
}