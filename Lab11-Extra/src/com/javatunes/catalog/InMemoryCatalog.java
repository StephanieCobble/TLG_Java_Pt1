...
//        MusicItem result = null;
    ...
    public Collection<MusicItem> findByCategory(MusicCategory category) {
        // declare return value, in this case, as emty result collection
        Collection<MusicItem> result = new ArrayList<>();
     ...
     */
    public Collection<MusicItem> findRockForLess(double price) {
        Collection<MusicItem> result = new ArrayList<>();
    ...
    /**
     * TASK: find the cheapest item with the specified genre (MusicCategory). // needs args
     */
     ...
     */
    public boolean allItemsAtLeastTen() {
        return false;
    }
