...
import static java.time.temporal.TemporalAdjusters.*; // for static methods of this class

import static java.time.DayOfWeek.*; // for MONDAY instead of DayofWeek.MONDAY
...
//        testElectionDay();
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1992, 11, 8);
