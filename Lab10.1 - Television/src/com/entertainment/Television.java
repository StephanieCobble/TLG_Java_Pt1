...
public class Television {
    ...
    public Television(String brand) throws InvalidBrandException { // this *
    ...
    // This method *might* throw InvalidBrandException
    public void setBrand(String brand) throws InvalidBrandException {
        if (isValidBrand(brand)) {
            ...
            throw new InvalidBrandException("Invalid brand: " + brand + ". Valid brands are " + brands + ".");
        }
    }
...
//            throw new IllegalArgumentException("Invalid volume: " + volume + ". Please set volume between " +
//                    MIN_VOLUME + " and " + MAX_VOLUME + ".");
            throw new IllegalArgumentException(String.format("Invalid volume: %s. Please set volume between %s and %s.",
