...
public class Book {
    ...
    private long isbn;
    private BookType bookType; //Constraints: [eBook, paperback, hardcover]; for validation
    //enum bookType {
    //EBOOK, PAPERBACK, HARDCOVER
    //}
    private int bookLength;
    private LocalDate publishDate;
    //bookLength - when pages run out, shelve book
    // revenue, #sold, genre, year published (see Movie stuff in scratch)
...
//                break;
//            default:
//                System.out.println("Invalid bookType: " + bookType +
//                        ". Please choose eBook, Paperback, or Hardcopy");
//        }
    }
